...
\begin{align}
    ...
    % \alpha \cdot f \big(\frac{n}{\beta} \big) = \alpha \cdot 2^{\frac{x}{\beta}} \\&
    % \beta \cdot f(n) = k \cdot 2^x \\&
    % \alpha \cdot 2^{\frac{x}{\beta}} \leq k \cdot 2^x | \cdot \frac{1}{2^x} \\&
    % \alpha \cdot 2^{\frac{x}{\beta}-x} \leq k \\&
    % \alpha \cdot 2^{x(\frac{1}{\beta}-1)} \leq k
\end{align}
